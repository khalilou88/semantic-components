  ...
  template: `
    <div class="bg-background text-foreground font-sans leading-7 max-w-3xl mx-auto p-6">
      <header>
        ...
        <p class="text-xl text-foreground leading-7 mt-4">
          A simple implementation of the shadcn/ui typography system using HTML and Tailwind CSS.
        </p>
      </header>
      ...
      <main class="mt-12">
        <section>
          ...
          <h1 class="scroll-m-20 text-4xl font-extrabold tracking-tight lg:text-5xl mt-6">
            Heading 1
          </h1>
          <h2 class="scroll-m-20 border-b pb-2 text-3xl font-semibold tracking-tight mt-10">
            Heading 2
        ...
        <section>
          ...
          <p class="leading-7 [&:not(:first-child)]:mt-6">
            This is a standard paragraph with default styling. The paragraph has proper line height
            and spacing to ensure readability across your application.
          </p>
          <p class="leading-7 [&:not(:first-child)]:mt-6">
          ...
          <p class="text-xl text-foreground leading-7 mt-6">
            This is a lead paragraph, used for introductions or to emphasize important information
            with larger text.
          </p>
          <p class="text-lg font-medium mt-6">
            This is slightly larger text that can be used for emphasis without being as prominent as
            a lead paragraph.
          </p>
          <p class="text-sm font-medium leading-none mt-6">
            This is smaller text, useful for captions, footnotes, or secondary information that
            doesn't need emphasis.
          </p>
          <p class="text-sm text-muted-foreground mt-6">
            This is muted text with reduced emphasis, perfect for supplementary information,
            metadata, or less important details.
          </p>
        </section>
...
<code class="text-sm font-mono">{{code}}</code>
      ...
      <footer class="mt-16 pt-8 border-t">
        <p class="text-sm text-muted-foreground">
          This example demonstrates how to implement a shadcn/ui-inspired typography system using
