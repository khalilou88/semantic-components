...
import { SiChevronRightIcon, SiMinusIcon, SiPlusIcon } from '@semantic-icons/lucide-icons';
        ...
        <nav sc-breadcrumb>
          <ol sc-breadcrumb-list>
            ...
            <li sc-breadcrumb-item>
              <span sc-breadcrumb-page>Input Number</span>
            </li>
          </ol>
        </nav>

        <h1 sc-page-title>Input Number</h1>

        <p sc-page-description>A numeric input element with increment and decrement buttons.</p>
...
export default class InputNumberGroupPage {
  ...
  templateCodeSnippet = `<div sc-input-number-group>
  <input sc-input-number />
