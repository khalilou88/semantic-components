  ...
  template: `
    <div class="relative py-6 lg:gap-10 lg:py-8 xl:grid xl:grid-cols-[1fr_300px] px-4">
      <div class="mx-auto w-full max-w-3xl">
        <nav sc-breadcrumb>
          <ol sc-breadcrumb-list>
            ...
            <li sc-breadcrumb-item>
              <span sc-breadcrumb-page>Progress</span>
            </li>
          </ol>
        </nav>

        <h1 sc-page-title>Progress</h1>
        ...
        <section class="my-10" id="indeterminate-state">
          <h3 class="mb-2" sc-heading level="3">Indeterminate state</h3>
...
export default class ProgressPage implements OnInit {
  ...
  templateCodeSnippet = `<sc-progress [value]="progress()" />`;
}
