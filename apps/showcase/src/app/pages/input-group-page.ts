        ...
        <nav sc-breadcrumb>
          <ol sc-breadcrumb-list>
            ...
            <li sc-breadcrumb-item>
              <span sc-breadcrumb-page>Input Group</span>
            </li>
          </ol>
        </nav>

        <h1 sc-page-title>Input Group</h1>

        <p sc-page-description>Input Group with icons.</p>
...
export default class InputGroupPage {
  ...
  templateCodeSnippet = `<sc-input-group>
  <svg si-dollar-sign-icon></svg>
  <input sc-input />
  <svg si-circle-help-icon></svg>
</sc-input-group>`;
