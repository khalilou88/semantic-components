      ...
      <div class="mx-auto w-full max-w-screen-xl">
        <div class="grid grid-cols-2 gap-8 px-4 py-6 lg:py-8 md:grid-cols-4">
          ...
          <div>
            ...
            <ul class="text-gray-500 dark:text-gray-400 font-medium">
              <li class="mb-4">
                <a class="hover:underline" href="#">iOS</a>
              </li>
              <li class="mb-4">
                <a class="hover:underline" href="#">Android</a>
              </li>
              <li class="mb-4">
                <a class="hover:underline" href="#">Windows</a>
              </li>
              <li class="mb-4">
                <a class="hover:underline" href="#">MacOS</a>
              </li>
            </ul>
          </div>
        </div>
        ...
        >
          ...
          <div class="flex mt-4 sm:justify-center md:mt-0 space-x-5 rtl:space-x-reverse">
            <a class="text-gray-400 hover:text-gray-900 dark:hover:text-white" href="#">
              <svg
                class="w-4 h-4"
                aria-hidden="true"
