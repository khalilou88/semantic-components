    ...
    <div class="flex justify-center dark:bg-gray-900" id="exampleWrapper">
      <div id="datepicker-inline" inline-datepicker="">
        <div class="datepicker datepicker-inline active block">
          <div
            class="datepicker-picker inline-block rounded-lg bg-white p-4 shadow-lg dark:bg-gray-700"
          >
            <div class="datepicker-header">
              <div
                ...
                style="display: none;"
              ></div>
              <div class="datepicker-controls mb-2 flex justify-between">
                <button
                ...
                >
                  <svg
                    class="h-4 w-4 text-gray-800 rtl:rotate-180 dark:text-white"
                    aria-hidden="true"
            ...
            <div class="datepicker-main p-1">
              <div class="datepicker-view flex">
                <div class="days">
                  ...
                  <div class="datepicker-grid grid w-64 grid-cols-7">
                    <span
                    ...
                    <span
                      class="datepicker-cell day block flex-1 cursor-pointer rounded-lg border-0 text-center text-sm font-semibold leading-9 text-gray-900 hover:bg-gray-100 dark:text-white dark:hover:bg-gray-600"
                    ...
                    <span
                      class="datepicker-cell day selected !bg-primary-700 dark:!bg-primary-600 focused block flex-1 cursor-pointer rounded-lg border-0 bg-blue-700 text-center text-sm font-semibold leading-9 text-white dark:bg-blue-600"
                    ...
                    <span
                      class="datepicker-cell day next block flex-1 cursor-pointer rounded-lg border-0 text-center text-sm font-semibold leading-9 text-gray-500 text-gray-900 hover:bg-gray-100 dark:text-white dark:hover:bg-gray-600"
            ...
            <div class="datepicker-footer">
              <div class="datepicker-controls mt-2 flex space-x-2 rtl:space-x-reverse">
                <button
                  class="button today-btn !bg-primary-700 dark:!bg-primary-600 hover:!bg-primary-800 dark:hover:!bg-primary-700 focus:!ring-primary-300 w-1/2 rounded-lg bg-blue-700 px-5 py-2 text-center text-sm font-medium text-white hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700"
                  type="button"
                  style="display: none;"
                >
                  Today
                ...
                <button
                  class="button clear-btn focus:!ring-primary-300 w-1/2 rounded-lg border border-gray-300 bg-white px-5 py-2 text-center text-sm font-medium text-gray-900 hover:bg-gray-100 focus:ring-4 focus:ring-blue-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:hover:bg-gray-600"
                  type="button"
                  style="display: none;"
                >
                  Clear
